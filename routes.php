...
// The output -> Index
get('/', 'views/index.php');
get('/auth', 'Modules/Auth/views/index.php');
get('/post', 'Modules/Post/views/index.php');
get('/products', 'Modules/Products/views/index.php');
get('/profile', 'Modules/Profile/views/index.php');
